      ...
      setInsights([
        {
          id: "fallback-1",
          type: "info",
          title: "IA Temporariamente no disponible",
          message:
            "Estamos trabajando para restaurar las conclusiones de IA. Por favor, revisa más tarde.",
        ...
        prev.map((a) =>
          a.insightId === insight.id
            ? {
                ...a,
                answer:
                  "Lo sentimos, no pude generar una respuesta detallada. Por favor, intenta de nuevo.",
                isLoading: false,
              }
            : a
        )
        ...
        <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
              Analizando tus patrones de gastos
            </p>
          </div>
        ...
        <div className="mt-4 sm:mt-6 pt-3 sm:pt-4 border-t border-gray-100 dark:border-gray-700 text-center">
          <div className="flex items-center justify-center gap-2 text-sm text-gray-500 dark:text-gray-400">
            ...
            <span className="text-xs sm:text-sm">
              IA está analizando tus patrones financieros...
            </span>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-0">
          <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
            ...
            <span className="font-medium text-xs">
              Potenciado por el análisis de IA
            </span>
          </div>
          <button
            onClick={loadInsights}
          ...
          >
            ...
            <span className="hidden sm:inline">Actualizar conclusiones →</span>
          </button>
        </div>
      </div>
    </div>
