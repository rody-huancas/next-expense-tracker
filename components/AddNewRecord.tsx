...
const AddRecord = () => {
  ...
  const handleAISuggestCategory = async () => {
    ...
    try {
      ...
      if (result.error) {
        setAlertMessage(`Sugerencia de IA: ${result.error}`);
        setAlertType("error");
      } else {
        setCategory(result.category);
        setAlertMessage(`Categoría sugerida por IA: ${result.category}`);
        setAlertType("success");
      }
    } catch {
      setAlertMessage("Error al obtener la sugerencia de categoría de IA");
      setAlertType("error");
    } finally {
      ...
      <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
            Controla tus gastos con la ayuda de IA
          </p>
        </div>
      </div>
      <form
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              <input
                ...
                placeholder="Café, comida, gasolina..."
                required
              />
              <button
                type="button"
            ...
            {isCategorizingAI && (
              <div className="flex items-center gap-2 text-xs text-emerald-600 dark:text-emerald-400">
                ...
                IA está analizando tu descripción...
              </div>
            )}
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 p-3 sm:p-4 bg-gradient-to-r from-green-50/50 to-emerald-50/50 dark:from-green-900/10 dark:to-emerald-900/10 rounded-xl border border-green-100/50 dark:border-green-800/50">
          ...
          <div className="space-y-1.5">
            ...
            >
              ...
              <span className="text-xs text-gray-400 dark:text-gray-500 ml-2 font-normal hidden sm:inline">
                Usa el botón ✨ arriba para sugerencias de IA
              </span>
            </label>
            <select
              id="category"
          ...
          <div className="space-y-1.5">
            ...
            >
              ...
              Importe
              <span className="text-xs text-gray-400 dark:text-gray-500 ml-2 font-normal hidden sm:inline">
                Introduce un importe entre $0 y $1,000
              </span>
            </label>
            <div className="relative">
